...
class LayoutLMv3Embeddings(nn.Module):
    ...
    def _calc_spatial_position_embeddings(self, bbox):
        try:
            ...
            x1_position_embeddings = self.x_position_embeddings(bbox[:, :, 0])
            y1_position_embeddings = self.y_position_embeddings(bbox[:, :, 1])
            x2_position_embeddings = self.x_position_embeddings(bbox[:, :, 2])
            y2_position_embeddings = self.y_position_embeddings(bbox[:, :, 3])
            x3_position_embeddings = self.x_position_embeddings(bbox[:, :, 4])
            y3_position_embeddings = self.y_position_embeddings(bbox[:, :, 5])
            x4_position_embeddings = self.x_position_embeddings(bbox[:, :, 6])
            y4_position_embeddings = self.y_position_embeddings(bbox[:, :, 7])
        ...
        spatial_position_embeddings = torch.cat(
            [
                ...
                x1_position_embeddings,
                y1_position_embeddings,
                x2_position_embeddings,
                y2_position_embeddings,
                x3_position_embeddings,
                y3_position_embeddings,
                x4_position_embeddings,
                y4_position_embeddings,
                h_position_embeddings,
                w_position_embeddings,
            ],
            dim=-1,
